...
simulated_data <- averaged_data |>
  ...
  #use mutate (add column) wuth predict to obtain predicted
```
...
- MAKE ANIMATION THEN AVERAGE

- MAKE A RESIDUAL PLOT TO PROVE EQUAL VARIANCE (EQUAL VARIANCE CONDITION IN LINEAR REGRESSION)

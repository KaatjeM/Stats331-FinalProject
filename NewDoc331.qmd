...
We believe that the relationship between GDP and Energy use per Person will be positively correlated, meaning that a larger GDP for a country will lead to more energy use per person. We have elected to use the log scale of energy use per person, as doing so will create a stronger linear relationship between the variables, as seen through the gapminder tools.
In addition, through the years, with a rise in accessibility of sustainable energy, we believe that the overall trend of energy use per person will be positive. In addition, the rise of globalization has increased GDPs over time, leading to another positive trend.
